---
name: ontology
description: Typed knowledge graph for structured agent memory. Always active when user mentions: tasks, todo, pending, unresolved, problem, issue, need to do, should do, remember, recall, memory, 记得, 记住, 待办, 问题, 没解决, 有什么, 查询, 搜索 - handles entity creation, querying, linking, and cross-skill data access.
---
